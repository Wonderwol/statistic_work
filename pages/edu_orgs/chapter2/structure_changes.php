...
<head>
  ...
  <title>Изменение структуры сети ОО</title>

  <script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.1/dist/chart.umd.min.js"></script>

  <?php
    include $docRoot . '/statistics/styles/edu_orgs/chapter2/style.php';
...
<div class="content-area">
  <div class="container">
    ...
    $breadcrumbs = [
      ...
      ['title' => ' Изменение структуры сети ОО'],
    ];
    ...
    <div class="dropdown-search-container" id="locality-container">
      ...
      <div class="dropdown-checkbox-group" id="locality-group">
        ...
        <div class="buttons">
          ...
          <button type="button" class="btn-secondary" onclick="window.location.href='/statistics/pages/edu_orgs/chapter2/structure_changes.php'">Сбросить</button>
        </div>
      </form>
    </div>
    ...
    <?php if (!empty($hasOrganizations)): ?>
        ...
        <div class="chart-box chart-box--card">
          <div class="chart-header">
            <div>
              ...
              <div class="chart-subtitle">Доли от общего количества организаций, выраженные в процентах (%).</div>
            </div>
          </div>
      ...
      <div class="chart-container">
        <div class="chart-box chart-box--card">
          <div class="chart-header">
            <div>
              <h3>СОШ: структура по видам (100%), %</h3>
              <div class="chart-subtitle">Доли от общего количества организаций, выраженные в процентах (%).</div>
            </div>
          </div>
...
include $docRoot . '/statistics/scripts/edu_orgs/chapter2/structure_changes_script.php';
?>
</body>
</html>
